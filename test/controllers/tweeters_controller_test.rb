...
class TweetersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tweeter" do
    assert_difference('Tweeter.count') do
      post tweeters_url, params: { tweeter: { content: @tweeter.content, user_id: @tweeter.user_id } }
    end
  ...
  test "should update tweeter" do
    patch tweeter_url(@tweeter), params: { tweeter: { content: @tweeter.content, user_id: @tweeter.user_id } }
